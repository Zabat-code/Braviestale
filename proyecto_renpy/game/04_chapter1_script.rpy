...
label ataque_aldea:
    ...
    # --- Beat de PNJ secundario: el guardia (visto luego en la ciudad como
    # CORWYN) aparece aquí cubriendo la retirada, dando coherencia temprana al
    # mundo y mostrando que la aldea no cae sin resistencia.
    show guardia at right with movein_right
    guardia "¡Por la herrería! ¡Cubrid la retirada de los niños!"
    guardia "Yo aguanto a estos hijos de… —¡corran, no miren atrás!"
    hide guardia with moveout_right
    "El guardia se queda entre el humo, espada en alto. No lo vuelves a ver hasta la Ciudadela."
